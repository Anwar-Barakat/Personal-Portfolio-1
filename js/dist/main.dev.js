...
// & Switcher Color : 
// &&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
var switcher = document.querySelector('.style-switcher-toggler');
...
function changeColor() {
  ...
  document.documentElement.style.setProperty('--change-color', color); // let secondColor = this.getAttribute('data-second');
